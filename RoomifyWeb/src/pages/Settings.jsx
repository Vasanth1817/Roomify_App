...
const Settings = () => {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ background: 'var(--surface)', padding: '2rem', borderRadius: '12px', marginTop: '2rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 0' }}>
          <div>
            ...
            <p style={{ margin: 0, color: 'var(--text-muted)', fontSize: '0.9rem' }}>Toggle between dark and light themes</p>
          </div>
          <button 
      ...
      <div style={{ background: 'var(--surface)', padding: '2rem', borderRadius: '12px', marginTop: '2rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 0' }}>
          <div>
            ...
            <p style={{ margin: 0, color: 'var(--text-muted)', fontSize: '0.9rem' }}>Receive alerts about budget limits and designs</p>
          </div>
      ...
      <div style={{ background: 'var(--surface)', padding: '2rem', borderRadius: '12px', marginTop: '2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <button style={{ background: '#ff4d4d', border: 'none', color: 'var(--text-main)', padding: '1rem', borderRadius: '8px', cursor: 'pointer', textAlign: 'left', fontWeight: 'bold' }}>
            Reset All Designs
          </button>
        </div>
      </div>
